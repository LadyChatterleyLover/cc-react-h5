// import CcIcon from '../../components/icon'
            ...
            <div key={index}>
              <div className='text-sm mb-5 text-stone-500'>{item.title}</div>
              {
                item.item.map((item1: Item, index1: number) => {
                  return (
                    <div className='relative flex items-center py-5 bg-white h-11 rounded-3xl mb-3 text-base' style={{boxShadow: '0 1px 4px 0 rgb(102 102 102 / 6%)' }} key={index1} onClick={() => clickItem(item1)}>
